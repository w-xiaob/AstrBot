            ...
            "platform": {
                ...
                "config_template": {
                    ...
                    "飞书(Lark)": {
                        ...
                        "lark_webhook_port": 6198,
                        "lark_webhook_path": "/astrbot-lark-webhook/callback",
                        "lark_encrypt_key": "",
                ...
                "items": {
                    ...
                    "lark_connection_mode": {
                        ...
                        "type": "string",
                        "options": ["webhook", "socket"],
                        "hint": "飞书的连接模式。`webhook` 使用 Webhook 服务器，`socket` 使用飞书的 Socket 模式。",
                    },
                    "lark_webhook_host": {
                        "description": "飞书 Webhook 主机地址",
                        "type": "string",
                        "hint": "仅在飞书连接模式为 `webhook` 时有效。",
                    },
                    "lark_webhook_port": {
                        "description": "飞书 Webhook 端口",
                        "type": "int",
                        "hint": "仅在飞书连接模式为 `webhook` 时有效。",
                    },
                    "lark_webhook_path": {
                        "description": "飞书 Webhook 路径",
                        "type": "string",
                        "hint": "仅在飞书连接模式为 `webhook` 时有效。",
                    },
                    "lark_encrypt_key": {
                        "description": "飞书加密密钥",
                        "type": "string",
                        "hint": "飞书 Webhook 的加密密钥，用于验证请求来源。",
                    },
                    "lark_verification_token": {
                        "description": "飞书验证令牌",
                        "type": "string",
                        "hint": "飞书 Webhook 的验证令牌，用于验证请求来源。",
                    },
                    "discord_token": {
